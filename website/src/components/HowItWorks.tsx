      ...
      <div className="relative max-w-7xl mx-auto px-6" ref={ref}>
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass mb-6">
            <span className="text-teal-accent dark:text-teal-accent text-teal-600 text-sm font-medium">How It Works</span>
          </div>
              ...
              >
                ...
                <div className={`${index % 2 === 0 ? 'lg:text-right lg:pr-16' : 'lg:pl-16 lg:order-2'}`}>
                  <div className={`flex items-center gap-4 mb-4 ${index % 2 === 0 ? 'lg:justify-end' : ''}`}>
                    <span className="text-5xl font-bold text-teal-accent/20 dark:text-teal-accent/20 text-teal-100">{step.number}</span>
                    <h3 className="text-2xl font-bold dark:text-white text-slate-800">{step.title}</h3>
                  </div>
                  <p className="dark:text-white/50 text-slate-800 text-lg leading-relaxed">
                    {step.description}
                  </p>
                </div>
                ...
                <div className="lg:hidden mt-6">
                  <div className="w-16 h-16 rounded-xl bg-gradient-to-br from-teal-accent/20 to-teal-accent/5 dark:from-teal-accent/20 dark:to-teal-accent/5 from-teal-100 to-teal-50 border border-teal-accent/30 dark:border-teal-accent/30 border-teal-200 flex items-center justify-center text-teal-accent dark:text-teal-accent text-teal-600">
                    {step.icon}
                  </div>
                </div>
              </motion.div>
