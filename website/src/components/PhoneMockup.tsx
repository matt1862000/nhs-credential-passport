        ...
        <div className="phone-screen aspect-[9/19.5] relative overflow-hidden bg-white dark:bg-black rounded-[2.5rem] border-4 border-slate-800 dark:border-slate-900">
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-b from-blue-50 via-white to-slate-50 dark:from-deep-navy dark:to-midnight overflow-hidden">
              ...
              <div className="absolute bottom-2 sm:bottom-6 left-4 right-4 z-30">
              ...
              {/* Time remaining - positioned just under the notch on all screen sizes */}
          ...
          >
            <div className="text-center w-full">
              ...
              {/* Route suggestion - positioned lower */}
              <div className="mt-8 mb-4 p-4 rounded-2xl bg-teal-50 dark:bg-teal-accent/10 border-2 border-teal-300 dark:border-teal-accent/20">
