...
export default function ForClinicians() {
  ...
  return (
    <section id="for-clinicians" className="relative py-32 overflow-hidden">
      {/* Background */}
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full glass mb-6">
              <span className="text-teal-accent dark:text-teal-accent text-teal-600 text-sm font-medium">For Healthcare Professionals</span>
            </div>
            ...
            <p className="dark:text-white/50 text-slate-800 text-lg mb-10 leading-relaxed">
            ...
            <div className="mt-10 flex flex-wrap gap-4">
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                className="px-8 py-4 rounded-full bg-gradient-to-r from-teal-accent to-teal-accent/80 text-midnight font-semibold"
              >
                Get Started Free
              </motion.a>
              <motion.a
                ...
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="px-8 py-4 rounded-full glass dark:text-white text-slate-700 font-semibold hover:bg-white/10 dark:hover:bg-white/10 hover:bg-slate-100"
              >
                Download Resources
              </motion.a>
            </div>
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-4 mb-8">
              {stats.map((stat, index) => (
                ...
                >
                  <div className="text-4xl font-bold text-teal-accent dark:text-teal-accent text-teal-600 mb-2">{stat.value}</div>
                  <div className="text-sm dark:text-white/50 text-slate-800">{stat.label}</div>
                </motion.div>
              ))}
            </div>
