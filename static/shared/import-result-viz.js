...
(function (w) {
  ...
  function esrImport(el, data, opts) {
    ...
    if (invalidN > 0) {
      notes.push('Rows that need fixing appear on the <strong>My training</strong> tab — hide the notice, then use <strong>Add manually</strong> or dismiss each reminder.');
    }
    render(el, {
      total: total,
